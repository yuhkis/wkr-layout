...
3. 実際の文章入力には [WKR macOS v2 beta 0.8.0-beta.5](https://github.com/yuhkis/wkr-macos/releases/tag/v0.8.0-beta.5) とApple日本語入力を使います。[実装の違い](docs/compatibility.md)も確認してください。
...
保存資料のタグは `v1.1.0-archive.1`、配列の版は `1.1.0` です。アプリ・練習は含みません。現行WKR macOS v2 betaと練習帳はv2用です。
