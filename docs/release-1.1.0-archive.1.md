...
この保存版にはmacOSアプリや練習アプリを含みません。現行の[WKR macOS v2 beta](https://github.com/yuhkis/wkr-macos)と練習帳はv2用です。新しく使う場合は[v2の公開ベータ](https://github.com/yuhkis/wkr-layout/releases/tag/v2.0.0-beta.1)を参照してください。
